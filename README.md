...
## ●　Room
Show how to use `Room` api.

See at ./app/src/main/java/com/ellison/jetpackdemo/room
...
## ●　AppCompat
Show DynamicTint and AutoSize feature with `AppCompat` API.

See at ./app/src/main/java/com/ellison/jetpackdemo/appCompat
